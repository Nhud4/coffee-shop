      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
        <div className="space-y-4 px-2">
          ...
          <div className="flex justify-center items-center">
            <Image className="object-cover md:h-48 md:w-48 h-32 w-32 -mr-[6rem] z-10" src={require('@/assets/image/IMG_05.jpg')} alt="image1" />
        ...
        <div className="space-y-4 px-2">
          ...
          <div className="flex justify-center items-center">
            <Image className="object-cover md:h-48 md:w-48 h-32 w-32 -mr-[6rem] z-10" src={require('@/assets/image/IMG_02.jpg')} alt="image1" />
            <div className="md:pt-4 py-3 pl-[7rem] pr-3 md:space-y-4 bg-nero-10 w-full md:h-56 h-38 z-0">
              <h1 className="text-xl font-semibold text-cyn-20 tracking-widest">Expresso Coffee</h1>
              <ul className="opacity-50 tracking-wider">
                <li className="flex items-center space-x-2">
